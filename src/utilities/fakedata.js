const breakfast = [
  {
    ...
    img: "https://i.ibb.co/zQ1c1yY/toast-with-avocado-spinach-and-fried-egg-top-view.jpg",
    price: 9.99,
    description:
  ...
  },
  {
    id: "FnU3e0K",
    foodName: "Pan Cakes",
    img: "https://i.ibb.co/r4yZw9R/A-stack-of-pancakes-on-a-plate-with-syrup-and-butter-Isolated-on-white-with-clipping-path.jpg",
    price: 6.99,
    description:
  ...
  {
    id: "0M03yhi",
    foodName: "Chicken and waffles",
    img: "https://i.ibb.co/F348xkq/Fried-Chicken-and-Waffles-with-Syrup-is-Classic-Southern-Comfort-food-Photographed-on-Hasselblad-H3.jpg",
    price: 12.99,
    description:
  ...
  },
  {
    id: "8YMQwoL",
    foodName: "Home fries",
    img: "https://i.ibb.co/DM0JZYY/chips-against-white.jpg",
    price: 7.99,
    description:
      "Home fries is a popular American side dish made by frying larger chunks of potatoes in butter or oil until they are crispy and golden in color. The potatoes might sometimes be unpeeled, and they are often shortly boiled or steamed before frying. Home fries are often paired with onions and peppers in the same pan.",
  },
  {
    id: "KG5Khcd",
    foodName: "Breakfast burrito",
    img: "https://i.ibb.co/0r18jrX/Breakfast-Burrito-with-Hash-Brown-Potatoes-and-Salsa-Photographed-on-Hasselblad-H3-D2-39mb-Camera.jpg",
    price: 4.99,
    description:
  ...
  },
  {
    ...
    img: "https://i.ibb.co/GkZB7ms/Bacon-Egg-and-Cheese-Breakfast-Sandwich-on-a-Toasted-English-Muffin-with-a-Natural-Drop-Shadow-Photo.jpg",
    price: 12.99,
    description:
      "A breakfast sandwich is any sandwich filled with foods associated with the breakfast meal. Breakfast sandwiches are served at fast food restaurants and delicatessens or bought as fast, ready to heat and eat sandwiches from a store. Breakfast sandwiches are commonly made at home.",
  },
];
...
const lunch = [
  ...
  },
  {
    ...
    price: 12.99,
    description:
      "A BLT is a type of sandwich, named for the initials of its primary ingredients, bacon, lettuce, and tomato. It can be made with varying recipes according to personal preference. Simple variants include using different types of lettuce, toasting or not, or adding mayonnaise.",
  },
  {
    id: "Wo607Rl",
...
const dinner = [
  {
    id: "ZMMVSzA",
    foodName: "Meatloaf",
    img: "https://i.ibb.co/7R5mVWS/A-white-plate-of-turkey-meatloaf-cooked-fresh-carrots-and-mashed-potatoes-and-mushroom-gravy-on-a-wh.jpg",
    price: 7.99,
    description:
  ...
  },
  {
    ...
    img: "https://i.ibb.co/sRCCJCv/Fried-chicken-with-macaroni-and-cheese-mashed-potatoes-with-gravy-and-sweat-tea-Please-see-my-portfo.jpg",
    price: 5.99,
    description:
  ...
  },
  {
    id: "AUFHBoN",
    foodName: "Fajitas",
    img: "https://i.ibb.co/tP7t474/An-overhead-close-up-of-two-fajita-tacos-splattered-with-hot-chipotle-sauce-on-a-white-plate.jpg",
    price: 7.99,
    description:
      "A fajita, in Tex-Mex cuisine, is any stripped grilled meat with stripped peppers and onions that is usually served on a flour or corn tortilla. The term originally referred to skirt steak, the cut of beef first used in the dish.",
  },
  {
    id: "GdFiA9X",
    foodName: "Baked beans",
    img: "https://i.ibb.co/5rKWxfG/plate-of-beans-in-tomato-on-white-background.jpg",
    price: 12.99,
    description:
  ...
  },
  {
    ...
    img: "https://i.ibb.co/yBVJyxy/Isolated-grilled-cheese-on-a-plate-with-white-background.jpg",
    price: 17.99,
    description:
      "A toasted sandwich, grilled cheese sandwich, cheese toastie, or grilled cheese is a hot sandwich made with one or more varieties of cheese on bread.",
  },
  {
    id: "Yr-Iymo",
    foodName: "Cheesecake",
    img: "https://i.ibb.co/9NdfRZd/A-New-York-Style-cheesecake-topped-with-cherries-on-a-white-background-PLEASE-CLICK-HERE-FOR-MORE-CH.jpg",
    price: 12.99,
    description:
